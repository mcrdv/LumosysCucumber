...
formatter.scenario({
  "line": 9,
  "name": "unsuccesful Login with no results",
  "description": "",
  "id": "lumosys-login;unsuccesful-login-with-no-results",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
  "line": 10,
  "name": "I have opened the imdb site",
  "keyword": "Given "
});
formatter.step({
  "line": 11,
  "name": "I Login with an unexist user",
  "keyword": "When "
});
formatter.step({
  "line": 12,
  "name": "I validate there are no Login",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
